...
class Day10Tests: XCTestCase {
    ...
    func test_part1_sample_data5() throws {
        ...
        let asteroidPoints = readAsteroidMap(input)
        let (maxCount, p) = calculateBestAsteroidBaseCount(asteroidPoints)
    ...
    func test_part2_sample_data1() throws {
        ...
        XCTAssertEqual(Point(x: 14, y: 3), points[asteroidPoints.count-1])
    ...
    func test_part2() throws {
        ...
        XCTAssertEqual(Point(x: 22, y: 3), points[199])
        XCTAssertEqual(2203, points[199].x * 100 + points[199].y)
    }
}
